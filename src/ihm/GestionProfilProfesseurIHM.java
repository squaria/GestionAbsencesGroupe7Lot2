...
public class GestionProfilProfesseurIHM {
	...
	private void initialize() {
		...
		panel_7_2.setBackground(new Color(232, 236, 235));
		panel.add(panel_7_2);
		...
		panel_2_1_2.setBackground(new Color(232, 236, 235));
		...
		panel_2.setBackground(new Color(232, 236, 235));
		panel_5.add(panel_2);
		...
		panel_9.setBackground(new Color(232, 236, 235));
		panel_5.add(panel_9);
		...
		panel_7.setBackground(new Color(232, 236, 235));
		panel_1.add(panel_7);
		...
		panel_2_1.setBackground(new Color(232, 236, 235));
		...
		panel_12 = new JPanel();
		panel_12.setBackground(new Color(232, 236, 235));
		...
		panel_7_1.setBackground(new Color(232, 236, 235));
		panel_3.add(panel_7_1);
		
		JLabel lblNewLabel_1_1_1 = new JLabel("Modifier un profil professeur (entrez une ou plusieures modifications)");
		...
		panel_2_1_1.setBackground(new Color(232, 236, 235));
		...
		panel_2_2.setBackground(new Color(232, 236, 235));
		...
		panel_9_1.setBackground(new Color(232, 236, 235));
		...
		panel_11.setBackground(new Color(232, 236, 235));
